        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2 relative">
            <div className="grid grid-cols-2 gap-4">
              <img src="https://picsum.photos/id/1018/600/800" alt="Decoração Villa & Mar" className="rounded-2xl shadow-lg mt-8" />
              <img src="https://picsum.photos/id/1019/600/800" alt="Praia próxima" className="rounded-2xl shadow-lg" />
            </div>
            {/* Decoration Element */}
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              A Pousada Villa & Mar nasceu do sonho de um casal em oferecer um refúgio que une a hospitalidade genuína de um lar com a tranquilidade revigorante do mar de Ubatuba. Aqui, o tempo anda mais devagar.
            </p>
